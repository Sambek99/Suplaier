...
VALUES
(1, NULL, NULL, 'Prueba de notificación', NOW(), 1);
...
(IdTipoNotificacion, Tipo, GoogleCodeRoundedIcon)
VALUES
(1, 'Sistema', 'notifications'),
(2, 'Compra', 'shopping_cart'),
(3, 'Propuesta', 'local_offer'),
(4, 'Oferta', 'campaign')
ON DUPLICATE KEY UPDATE
Tipo = VALUES(Tipo),
GoogleCodeRoundedIcon = VALUES(GoogleCodeRoundedIcon);

INSERT INTO Notificacion
(IdUsuario, IdOferta, IdCompra, Descripcion, FechaCrea, IdTipoNotificacion)
SELECT IdUsuario, NULL, NULL, 'Prueba de notificación', NOW(), 1
FROM Usuario
WHERE Usuario = 'wduran'
LIMIT 1;

ALTER TABLE Notificacion
ADD COLUMN Leida TINYINT DEFAULT 0;

UPDATE Notificacion
SET Leida = 1
WHERE Descripcion = 'Prueba de notificación';
...
CREATE TABLE IF NOT EXISTS TokenDispositivo (
    IdTokenDispositivo INT AUTO_INCREMENT PRIMARY KEY,
    IdUsuario INT,
    Token VARCHAR(255) NOT NULL,
    TipoDispositivo VARCHAR(50), -- Puede ser 'web', 'ios', 'android', etc.
